...
architecture STRUCTURE of uproc_top_level is
  ...
  component uproc_top_level_clock_div25_0_0 is
  port (
    clk : in STD_LOGIC;
    Q : out STD_LOGIC
  );
  end component uproc_top_level_clock_div25_0_0;
  ...
  signal clock_div25_0_Q : STD_LOGIC;
  signal clock_div_0_Q : STD_LOGIC;
  ...
  signal controls_0_d_Out : STD_LOGIC_VECTOR ( 15 downto 0 );
  ...
  signal my_alu_0_Q : STD_LOGIC_VECTOR ( 15 downto 0 );
  ...
  attribute X_INTERFACE_PARAMETER of clk : signal is "XIL_INTERFACENAME CLK.CLK, CLK_DOMAIN uproc_top_level_clk_0, FREQ_HZ 128000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0";
begin
  RXD <= uart_0_tx;
  btn_0_1 <= btn;
  clk_0_1 <= clk;
  ...
  RTS <= 'Z';
blk_mem_gen_0: component uproc_top_level_blk_mem_gen_0_0
     port map (
...
blk_mem_gen_1: component uproc_top_level_blk_mem_gen_1_0
     port map (
      ...
      clka => clk_0_1,
      dina(15 downto 0) => controls_0_d_Out(15 downto 0),
      douta(15 downto 0) => blk_mem_gen_1_douta(15 downto 0),
      wea(0) => controls_0_d_wr_en
    );
clock_div25_0: component uproc_top_level_clock_div25_0_0
     port map (
      Q => clock_div25_0_Q,
      clk => clk_0_1
    );
...
controls_0: component uproc_top_level_controls_0_0
     port map (
      ...
      aluResult(15 downto 0) => my_alu_0_Q(15 downto 0),
      ...
      d_In(15 downto 0) => blk_mem_gen_1_douta(15 downto 0),
      d_Out(15 downto 0) => controls_0_d_Out(15 downto 0),
...
my_alu_0: component uproc_top_level_my_alu_0_0
     port map (
      ...
      Q(15 downto 0) => my_alu_0_Q(15 downto 0),
      clk => clk_0_1,
      en => clock_div_0_Q
    );
