...
HD_PWD='C:/Users/Winte/OneDrive/Documents/College Textbooks and Materials/2024 Senior Spring/Embedded/Labs/Lab5v2/Lab5v2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log regs.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source regs.tcl -notrace
