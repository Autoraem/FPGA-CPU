...
//               Spring/Embedded/Labs/Lab5v2/Lab5v2.gen/sources_1/bd/uproc_top_level/ip/uproc_top_level_controls_0_0/uproc_top_level_controls_0_0_stub.v}
...
module uproc_top_level_controls_0_0(clk, en, rst, rID1, rID2, wr_enR1, wr_enR2, regrD1, 
  regrD2, regwD1, regwD2, fbRST, fbAddr1, fbDin1, fbDout1, fbWr_en, irAddr, irWord, dAddr, d_wr_en, d_Out, 
  d_In, aluA, aluB, aluOp, aluResult, ready, newchar, send, charRec, charSend)
/* synthesis syn_black_box black_box_pad_pin="clk,en,rst,rID1[4:0],rID2[4:0],wr_enR1,wr_enR2,regrD1[15:0],regrD2[15:0],regwD1[15:0],regwD2[15:0],fbRST,fbAddr1[11:0],fbDin1[15:0],fbDout1[15:0],fbWr_en,irAddr[13:0],irWord[31:0],dAddr[14:0],d_wr_en,d_Out[15:0],d_In[15:0],aluA[15:0],aluB[15:0],aluOp[3:0],aluResult[15:0],ready,newchar,send,charRec[7:0],charSend[7:0]" */;
  input clk;
  input en;
  input rst;
  output [4:0]rID1;
