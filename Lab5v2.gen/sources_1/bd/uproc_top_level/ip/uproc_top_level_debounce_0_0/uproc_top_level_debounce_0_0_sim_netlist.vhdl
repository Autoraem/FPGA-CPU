...
--               Senior
--               Spring/Embedded/Labs/Lab5v2/Lab5v2.gen/sources_1/bd/uproc_top_level/ip/uproc_top_level_debounce_0_0/uproc_top_level_debounce_0_0_sim_netlist.vhdl}
...
architecture STRUCTURE of uproc_top_level_debounce_0_0_debounce is
  ...
  signal dbnc_i_8_n_0 : STD_LOGIC;
  signal p_0_in : STD_LOGIC;
  signal shift_register0_in : STD_LOGIC_VECTOR ( 1 to 1 );
...
dbnc_i_5: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
dbnc_i_6: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
dbnc_i_7: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
dbnc_i_8: unisim.vcomponents.LUT6
    generic map(
