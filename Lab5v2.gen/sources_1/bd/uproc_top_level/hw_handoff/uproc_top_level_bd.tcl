...
# module references:
# clock_div25, clock_div, controls, debounce, framebuffer, my_alu, pixel_pusher, regs, uart, vga_ctrl
...
proc create_root_design { parentCell } {
  ...
  set clk [ create_bd_port -dir I -type clk -freq_hz 128000000 clk ]
  ...
  # Create instance: clock_div25_0, and set properties
  set block_name clock_div25
  set block_cell_name clock_div25_0
  if { [catch {set clock_div25_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $clock_div25_0 eq "" } {
  ...
  set_property -dict [ list \
   CONFIG.Byte_Size {9} \
   CONFIG.Coe_File {../../../../../../../../New folder/Lab5_files_R1/Assembler/helloworld.coe} \
  ...
  set_property -dict [ list \
   CONFIG.Byte_Size {9} \
   CONFIG.Coe_File {../../../../../../../../New folder/Lab5_files_R1/Assembler/instructions.coe} \
   CONFIG.EN_SAFETY_CKT {false} \
   CONFIG.Enable_32bit_Address {false} \
   CONFIG.Enable_A {Always_Enabled} \
   CONFIG.Load_Init_File {true} \
  ...
  connect_bd_net -net blk_mem_gen_0_douta [get_bd_pins controls_0/irWord] [get_bd_pins irMem/douta]
  connect_bd_net -net blk_mem_gen_1_douta [get_bd_pins controls_0/d_In] [get_bd_pins dMem/douta]
  connect_bd_net -net btn_0_1 [get_bd_ports btn] [get_bd_pins debounce_0/btn]
  connect_bd_net -net clk_0_1 [get_bd_ports clk] [get_bd_pins clock_div25_0/clk] [get_bd_pins clock_div_0/clk] [get_bd_pins controls_0/clk] [get_bd_pins dMem/clka] [get_bd_pins debounce_0/clk] [get_bd_pins framebuffer_0/clk1] [get_bd_pins irMem/clka] [get_bd_pins my_alu_0/clk] [get_bd_pins pixel_pusher_0/clk] [get_bd_pins regs_0/clk] [get_bd_pins uart_0/clk] [get_bd_pins vga_ctrl_0/clk]
  connect_bd_net -net clock_div25_0_Q [get_bd_pins clock_div25_0/Q] [get_bd_pins framebuffer_0/en2] [get_bd_pins pixel_pusher_0/clken] [get_bd_pins vga_ctrl_0/clken]
  connect_bd_net -net clock_div_0_Q [get_bd_pins clock_div_0/Q] [get_bd_pins controls_0/en] [get_bd_pins framebuffer_0/en1] [get_bd_pins my_alu_0/en] [get_bd_pins regs_0/en] [get_bd_pins uart_0/en]
  ...
  connect_bd_net -net controls_0_d_Out [get_bd_pins controls_0/d_Out] [get_bd_pins dMem/dina]
  ...
  connect_bd_net -net my_alu_0_Q [get_bd_pins controls_0/aluResult] [get_bd_pins my_alu_0/Q]
