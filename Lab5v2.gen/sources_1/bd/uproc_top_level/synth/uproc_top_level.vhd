...
architecture STRUCTURE of uproc_top_level is
  ...
  attribute X_INTERFACE_PARAMETER of clk : signal is "XIL_INTERFACENAME CLK.CLK, CLK_DOMAIN uproc_top_level_clk, FREQ_HZ 128000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0";
begin
  RXD <= uart_0_tx;
  btn_0_1 <= btn;
  clk_0_1 <= clk;
...
dMem: component uproc_top_level_blk_mem_gen_1_0
     port map (
